...
class OptimizedGreedyIterator(GreedyIterator):
  def __init__(self, data: ndarray, data_indices: OrderedSet[int], preselection: ndarray, key_selector: KeySelector) -> None:
